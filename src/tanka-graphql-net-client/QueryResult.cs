...
namespace Tanka.GraphQL
{
    ...
    public class QueryRequest
    {
        ...
        /// </summary>
        /// <remarks>
        /// Fugu GraphQL execution engine uses <see cref="Extensions"/> to deliver arbitary information as part of your queries. This is not strigtly defined int he GraphQL spec but is used
        /// by many GraphQL implementations as a community standard.
        /// </remarks>
        [JsonConverter(typeof(VariableConverter))]
